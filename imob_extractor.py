...
Clasa ExtractorImobiliareRo:
    
    -> metoda getpagenumbers trimite un request catre imobiliare.ro si extrage cate pagini de anunturi sunt 
...
class ExtractorImobiliareRo:
    ...
    folderpath = f'{os.getcwd()}/.historic_data'
    ...
    def store_data(self):
        ...
        with open(f'{ExtractorImobiliareRo.folderpath}/{datetime.date(datetime.now())}.json', 'w') as fp:
